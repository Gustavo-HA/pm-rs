\documentclass[letterpaper,12pt,twoside,openany]{book}  % book class
...
\noindent A mis padres \textbf{Octavio} y \textbf{Abigail}. Su amor y sacrificio han sido fundamentales para cumplir mis metas. Gracias por ser un ejemplo de que cualquier obstáculo puede superarse. Espero que mis logros académicos sean un reflejo de su dedicación. \\[0.2cm]

\noindent A mis hermanos, \textbf{Arael} y \textbf{Javier}. Han sido siempre un modelo a seguir para mí, sé que siempre puedo aprender más de ustedes. Gracias por siempre mostrar su apoyo y comprensión. \\[0.2cm]

\noindent A \textbf{Yazmin}. Tu apoyo incondicional y tu amor han sido una fuente de fortaleza para mí. Gracias por ser la mejor compañia tanto en los momentos difíciles como en los felices. \\[0.2cm]

\noindent A mis amigos y compañeros de clase, por hacer este camino mucho más ameno y por su apoyo constante. \\[0.2cm]
