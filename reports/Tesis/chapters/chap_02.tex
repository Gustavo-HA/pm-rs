...
Los métodos basados en memoria (\textit{neighborhood-based}) generan predicciones directamente a partir de las interacciones históricas, sin aprender un modelo paramétrico explícito. Se distinguen dos variantes: basado en usuarios (\textit{user-based}) y basado en ítems (\textit{item-based}).
